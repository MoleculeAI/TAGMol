...
def sample_for_pocket(config_path, pdb_path, device, batch_size, result_path):
    ...
    all_pred_pos, all_pred_v, all_pred_pos_traj, all_pred_v_traj, all_pred_v0_traj, all_pred_vt_traj, all_pred_pos0_traj, time_list = sample_diffusion_ligand(
...
if __name__ == '__main__':
    ...
    sample_for_pocket(config_path=args.config,
    ...
    # # all_pred_pos, all_pred_v, all_pred_pos_traj, all_pred_v_traj, all_pred_v0_traj, all_pred_vt_traj, all_pred_pos0_traj, time_list
